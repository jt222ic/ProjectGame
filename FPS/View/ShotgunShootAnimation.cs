...
namespace FPS.View
{
    class ShotgunShootAnimation
    {
        int NumbersOfFrame = 15;
        float maxTime = 1;
        ...
        public ShotgunShootAnimation(Texture2D Reloading)
        {
        ...
        public void Draw(SpriteBatch spritebatch, Camera camera)
        {
            ...
            spritebatch.Draw(Shoot, new Vector2(650, 350), test, transition);
            spritebatch.End();
